...
void test_atoi_base(void) {
	...
	printf("%s\n\n", (number == 42) ? GREEN "Test Passed ✅" RESET :
	...
	printf("%s %d %s\n", CYAN "ft_atoi_base =>" YELLOW, number, RESET);
	printf("%s\n\n", (number == 66) ? GREEN "Test Passed ✅" RESET :
									  RED "Test Failed ❌" RESET);

	printf("String: \"42\", Base: \"%s\"\n", OCT_BASE);
	number = ft_atoi_base("42", OCT_BASE);
	printf("%s %d %s\n", CYAN "ft_atoi_base =>" YELLOW, number, RESET);
	printf("%s\n\n", (number == 34) ? GREEN "Test Passed ✅" RESET :
									  RED "Test Failed ❌" RESET);

	printf("String: \"DEAD\", Base: \"%s\"\n", HEX_BASE);
	number = ft_atoi_base("DEAD", HEX_BASE);
	printf("%s %d %s\n", CYAN "ft_atoi_base =>" YELLOW, number, RESET);
	printf("%s\n\n", (number == 57005) ? GREEN "Test Passed ✅" RESET :
										 RED "Test Failed ❌" RESET);
	...
	printf("%s %d %s\n", CYAN "ft_atoi_base =>" YELLOW, number, RESET);
	printf("%s\n\n", (number == 19) ? GREEN "Test Passed ✅" RESET :
									  RED "Test Failed ❌" RESET);

	printf("String: \"1001\", Base: \"%s\"\n", "011");
	number = ft_atoi_base("ey42", "011");
	printf("%s %d %s\n", CYAN "ft_atoi_base =>" YELLOW, number, RESET);
	printf("%s\n\n", (number == 0) ? GREEN "Test Passed ✅" RESET :
									 RED "Test Failed ❌" RESET);
